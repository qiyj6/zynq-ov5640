...
proc create_root_design { parentCell } {
  ...
  set clk_125m [ create_bd_port -dir I clk_125m ]
  ...
  set led_cam_init [ create_bd_port -dir O led_cam_init ]
  ...
  # Create instance: cam_config_top_0, and set properties
  set block_name cam_config_top
  set block_cell_name cam_config_top_0
  if { [catch {set cam_config_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $cam_config_top_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {336} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_JITTER {414.490} \
   CONFIG.CLKOUT2_PHASE_ERROR {335.459} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {24.000} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {204.968} \
   CONFIG.CLKOUT3_PHASE_ERROR {231.519} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {96.000} \
  ...
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {80.0} \
   CONFIG.CLKOUT1_JITTER {190.207} \
   CONFIG.CLKOUT1_PHASE_ERROR {233.292} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {168.000} \
   CONFIG.CLKOUT2_JITTER {119.942} \
   CONFIG.CLKOUT2_PHASE_ERROR {116.188} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {100.000} \
   CONFIG.CLKOUT2_USED {false} \
   CONFIG.CLK_OUT1_PORT {clk_168M} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {192} \
   ...
   CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 {0.04} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_GPIO_0 [get_bd_intf_ports gpio_led] [get_bd_intf_pins processing_system7_0/GPIO_0]
  ...
  connect_bd_net -net MSXBO_OVSensorRGB565_0_clk_ce [get_bd_pins MSXBO_OVSensorRGB565_0/clk_ce] [get_bd_pins rgb2gray_0/clk_ce_i]
  connect_bd_net -net MSXBO_OVSensorRGB565_0_hs_o [get_bd_pins MSXBO_OVSensorRGB565_0/hs_o] [get_bd_pins rgb2gray_0/hs_i]
  connect_bd_net -net MSXBO_OVSensorRGB565_0_rgb_o [get_bd_pins MSXBO_OVSensorRGB565_0/rgb_o] [get_bd_pins rgb2gray_0/rgb_i]
  connect_bd_net -net MSXBO_OVSensorRGB565_0_vs_o [get_bd_pins MSXBO_OVSensorRGB565_0/vs_o] [get_bd_pins rgb2gray_0/vs_i]
  connect_bd_net -net Net [get_bd_ports cam_sda] [get_bd_pins cam_config_top_0/cam_sda]
  connect_bd_net -net axi_vdma_0_mm2s_introut [get_bd_pins axi_vdma_0/mm2s_introut] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net cam_config_top_0_cam_init_done [get_bd_ports led_cam_init] [get_bd_pins cam_config_top_0/cam_init_done]
  connect_bd_net -net cam_config_top_0_cam_scl [get_bd_ports cam_scl] [get_bd_pins cam_config_top_0/cam_scl]
  connect_bd_net -net clk_125m_1 [get_bd_ports clk_125m] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins clk_wiz_2/clk_in1]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins HDMI_FPGA_ML_0/LOCKED_I] [get_bd_pins HDMI_FPGA_ML_0/RST_N] [get_bd_pins MSXBO_OVSensorRGB565_0/rst_n_i] [get_bd_pins clk_wiz_0/locked] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_ports cmos_xclk_o] [get_bd_pins clk_wiz_1/clk_out2]
  connect_bd_net -net clk_wiz_2_clk_168M [get_bd_pins clk_wiz_2/clk_168M] [get_bd_pins ila_0/clk]
  connect_bd_net -net clk_wiz_2_clk_out1 [get_bd_pins cam_config_top_0/clk_50m] [get_bd_pins clk_wiz_1/clk_out1]
  connect_bd_net -net cmos_data_i_1 [get_bd_ports cmos_data_i] [get_bd_pins MSXBO_OVSensorRGB565_0/cmos_data_i] [get_bd_pins ila_0/probe1]
  connect_bd_net -net cmos_href_i_1 [get_bd_ports cmos_href_i] [get_bd_pins MSXBO_OVSensorRGB565_0/cmos_href_i]
  connect_bd_net -net cmos_pclk_i_1 [get_bd_ports cmos_pclk_i] [get_bd_pins MSXBO_OVSensorRGB565_0/cmos_pclk_i] [get_bd_pins ila_0/probe0] [get_bd_pins rgb2gray_0/cmos_pclk_i] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net cmos_vsync_i_1 [get_bd_ports cmos_vsync_i] [get_bd_pins MSXBO_OVSensorRGB565_0/cmos_vsync_i]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins MSXBO_OVSensorRGB565_0/cmos_clk_i] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net rgb2gray_0_clk_ce_o [get_bd_pins rgb2gray_0/clk_ce_o] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net rgb2gray_0_gray_o [get_bd_pins rgb2gray_0/gray_o] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net rgb2gray_0_hs_o [get_bd_pins rgb2gray_0/hs_o] [get_bd_pins v_vid_in_axi4s_0/vid_active_video] [get_bd_pins v_vid_in_axi4s_0/vid_hsync]
  connect_bd_net -net rgb2gray_0_vs_o [get_bd_pins rgb2gray_0/vs_o] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  connect_bd_net -net rst_n_1 [get_bd_ports rst_n] [get_bd_pins cam_config_top_0/rst_n]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_ports cam_rst_n] [get_bd_pins xlconstant_2/dout]
